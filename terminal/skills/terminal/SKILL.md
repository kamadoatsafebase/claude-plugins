---
name: terminal
description: Open a path in a new Terminal window. Use when the user types /terminal, wants to open a directory in Terminal, or says "open X in terminal". Args are optional — defaults to cwd if omitted.
---
